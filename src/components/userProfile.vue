      ...
      <div class="col-xs-10 col-xs-offset-1">
        <form action="" role="form" class="form-horizontal">
          <div class="form-group">
            <label for="userName" class="col-xs-3 col-sm-2 control-label ">姓名</label>
            <div class="col-xs-9 col-sm-8 col-md-6">
              <input type="text" name="userName" id="userName" placeholder="您的姓名" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-9 col-md-8">
              <input type="number" name="telphone" id="telphone" placeholder="手机号码" class="form-control">
            ...
            <div class="col-xs-9 col-md-8">
              <div class="has-success">
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="fe" value="option1"> 前端
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="java" value="option1"> java
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="php" value="option1"> php
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="nodejs" value="option1"> nodejs
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="js" value="option1"> js
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="python" value="option1"> python
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="ruby" value="option1"> Ruby
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="c" value="option1"> C
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="c2" value="option1"> C++
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="c3" value="option1"> C#
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="android" value="option1"> Android
                  </label>
                </div>
                <div class="checkbox col-xs-4">
                  <label>
                    <input type="checkbox" id="ios" value="option1"> ios
                  </label>
                </div>
              </div>
              <br>
